  ...
  return (
    ...
    >
      ...
      <header className="absolute top-0 w-full flex items-center justify-between px-8 sm:px-10 py-10 sm:py-6">
        ...
        <button
          type="button"
          className="hidden sm:flex items-center gap-2 px-4 sm:px-5 py-2 rounded-md text-sm font-medium text-gray-700 bg-gray-200 border border-gray-300 hover:bg-gray-200 hover:border-gray-400 transition"
        >
