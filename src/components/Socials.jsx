...
const Socials = () => {
  return (
    <div className="fixed top-1/2 right-4 -translate-y-1/2 flex-col gap-5 z-50 hidden md:flex">
      <a
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="text-gray-500 dark:text-gray-400 hover:text-[#25D366] dark:hover:text-[#25D366] hover:scale-110 transition-[color,transform] duration-200 inline-block p-1"
